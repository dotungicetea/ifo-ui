...
export const NETWORK_POLYGON_NAME =
  process?.env?.NEXT_PUBLIC_NETWORK_POLYGON_NAME;
...
export const appNetworks = [
  {
    name: "Ethereum",
    networkName: APP_NETWORKS_NAME.METAMASK,
    id: ETH_CHAIN_ID,
  ...
  {
    name: "BSC",
    networkName: APP_NETWORKS_NAME.BSC,
    id: BSC_CHAIN_ID,
    icon: "/images/bsc.svg",
  ...
  {
    name: "Polygon",
    networkName: APP_NETWORKS_NAME.POLYGON,
    id: POLYGON_CHAIN_ID,
...
export const networkSupport: any[] = [
  {
    name: "Ethereum",
    id: ETH_CHAIN_ID,
    icon: "/images/header/ETH.svg",
    disableIcon: "/images/ethereum-disabled.png",
    currency: "ETH",
    networkName: NETWORK_ETH_NAME,
    details: {
      chainId: `0x${(+ETH_CHAIN_ID).toString(16)}`,
      chainName: NETWORK_ETH_NAME,
      nativeCurrency: {
        name: "ETH",
        symbol: "ETH",
        decimals: 18,
  ...
  },
  {
    name: "BSC Mainnet",
    id: BSC_CHAIN_ID,
    icon: "/images/header/BSC.svg",
    disableIcon: "/images/binance-disabled.png",
    currency: "BNB",
    networkName: NETWORK_BSC_NAME,
    details: {
      chainId: `0x${(+BSC_CHAIN_ID).toString(16)}`,
      chainName: NETWORK_BSC_NAME,
      nativeCurrency: {
        name: "BNB",
        symbol: "BNB",
        decimals: 18,
  ...
  },
  {
    name: "Polygon",
    id: POLYGON_CHAIN_ID,
    icon: "/images/header/Polygon.svg",
    disableIcon: "/images/polygon-matic-disabled.svg",
    currency: "MATIC",
    networkName: NETWORK_POLYGON_NAME,
    details: {
      chainId: `0x${(+POLYGON_CHAIN_ID).toString(16)}`,
      chainName: NETWORK_POLYGON_NAME,
      nativeCurrency: {
        name: "MATIC",
        symbol: "MATIC",
        decimals: 18,
